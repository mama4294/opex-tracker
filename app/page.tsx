...
// import type { CostItem, UtilityType } from "@/types/utility";

// type CostItemFormRow = {
//   id: string;
//   name: string;
//   category: string;
//   rate: string;
...
// /** Only call after mount (e.g. “Add line”); never in useState initializers — SSR must match client. */
// function newRowId() {
//   return `row-${crypto.randomUUID()}`;
// }

// /** Stable default id so server and client render the same initial form (avoids hydration mismatch). */
